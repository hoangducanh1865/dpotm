...
def add_training_argument(parser):
    ...
    parser.add_argument('--llm_type', type=str, default='openai_api') # ['openai_api', 'hf_model']
    ...
    parser.add_argument('--loss_dpo_topic_word_type', type=str, default='bradley_terry') # ['bradley_terry', 'plackett_luce']
    parser.add_argument('--loss_dpo_doc_topic_type', type=str, default='plackett_luce') # ['bradley_terry', 'plackett_luce']
    parser.add_argument('--generate_topic_descriptions_method', type=str, default='openai') # ['openai', 'hf'] 
    parser.add_argument('--topic_word_dataset_generate_method', type=str, default='openai') # ['openai', 'hf'] 
    parser.add_argument('--doc_topic_dataset_generate_method', type=str, default='hf') # ['openai', 'hf'] 
...
- Do not include explanations, only output the JSON object."""
    ...
    def get_doc_topic_prompt(topic_descriptions_str, batch_docs):
        ...
        for doc_data in batch_docs:
            ...
            prompt += f"Sort these topics by relevance: {top_5_topic_indices.tolist()}\n\n"
